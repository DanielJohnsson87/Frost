...
class CDatabase {
	...
	*/
	public function __construct($dsn, $username = null, $password = null, $driver_options =null) {
		...
		$this->db->SetAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); //Display errors but continue
	}
	...
	*/
	...
	/**
	* Execute a selct-query with arguments and return the resultset.
	*/
	...
	/**
	* Execute a SQL-query and ignoe the resultset.
	*/
