...
/**
  ...
  *
  * @param string $akronymOrEmail the emailadres or user akronym.
  ...
  */
  public function Login($akronymOrEmail, $password) {
  	...
  	if($user) {
  		...
  		$this->session->AddMessage('notice', "Could not login, user does not exists or password dod not match. ");
  	}
